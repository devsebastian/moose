...
function QueryBox({ name, value, pos, onQueryNameChange, onQueryValueChange, deleteQueryAt }) {
    return (
        <div className="new-query-box">
            ...
            <input className="query-name" value={name} placeholder="New Name" onChange={(e) => onQueryNameChange({ pos: pos, value: e.target.value })}></input>
            <input className="query-value" value={value} placeholder="New Value" onChange={(e) => onQueryValueChange({ pos: pos, value: e.target.value })}></input>
